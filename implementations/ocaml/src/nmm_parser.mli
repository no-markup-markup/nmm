(** An LR(1) parser of nmm source-code used by {!module:Doc_of_nmm} together
    with {!module:Nmm_lexer}. Generated from
    {{:specs/nmm_parser.mly.txt}nmm_parser.mly} with ocamlyacc. *)
...
val main :
  (Stdlib.Lexing.lexbuf -> token) -> Stdlib.Lexing.lexbuf -> Doc_types.tr_doc
