(** Specifies default tags and their expansions, and generates custom tag
    expansions from a tsv-file. *)
...
val tagger_of_path_opt :
  string option -> Doc_types.tr_blk_itm -> Doc_types.tr_blk_itm
