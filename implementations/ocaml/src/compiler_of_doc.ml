...
let acc_of_ts_blk_txt (doc_settings : t_doc_settings) (cref_table : t_cref_table) (path : t_path) (acc : t_acc) (a : ts_blk_txt) : t_acc =
        match acc with
                | MARGIN_LABELS _
                | CREF_TABLE _ -> acc
...
let acc_of_tr_dsp_line (doc_settings : t_doc_settings) (cref_table : t_cref_table) (path : t_path) (acc : t_acc) (a : tr_dsp_line) : t_acc =
        match acc with
        | MARGIN_LABELS _ -> acc
        | CREF_TABLE table -> (
...
let acc_of_ts_blk_dsp (doc_settings : t_doc_settings) (cref_table : t_cref_table) (auto_nr : int) (path : t_path) (acc : t_acc) (a : ts_blk_dsp) : t_acc * int =
...
let rec acc_of_ts_blks (doc_settings : t_doc_settings) (cref_table : t_cref_table) (path : t_path) (acc : t_acc) (a : ts_blks) : t_acc =
...
let rec acc_of_ts_pars (doc_settings : t_doc_settings) (cref_table : t_cref_table) (path : t_path) (acc : t_acc) (a : ts_pars) : t_acc =
...
let rec acc_of_ts_secs (doc_settings : t_doc_settings) (cref_table : t_cref_table) (path : t_path) (acc : t_acc) (a : ts_secs) : t_acc =
...
let rec acc_of_ts_chs (doc_settings : t_doc_settings) (cref_table : t_cref_table) (path : t_path) (acc : t_acc) (a : ts_chs) : t_acc =
...
let acc_of_ts_abstract (doc_settings : t_doc_settings) (cref_table : t_cref_table) (doc_class : t_doc_class) (path : t_path) (acc : t_acc) (a : ts_abstract) : t_acc =
        match a with
...
let acc_of_ts_refs (doc_settings : t_doc_settings) (cref_table : t_cref_table) (doc_class : t_doc_class)  (path : t_path) (acc : t_acc) (a : ts_refs) : t_acc =
        match a with
        |Cs_refs (b : ts_blks) -> 
                match acc with
                |LINES _ -> (
...
let rec acc_of_tr_doc (doc_settings : t_doc_settings) (cref_table : t_cref_table) (acc : t_acc) (doc : tr_doc) : t_acc =
