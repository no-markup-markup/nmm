...
|Xml.Element ("par_lbl", _, xml_list) -> Xml.Element ("div",[("style","display:block;float:left")],List.map (html_of_exml doc_class) xml_list)
|Xml.Element ("par_hdr", attr_list, xml_list) -> Xml.Element ("h4", [("style","visibility:hidden;height:0;width:0;float:left")], List.map (html_of_exml doc_class) xml_list)
...
|Xml.Element ("blk_txt", _, xml_list) -> Xml.Element ("p", [("class", "blk_txt");("style","margin-top:0")], List.map (html_of_exml doc_class) xml_list)

|Xml.Element ("blk_itm", attr_list, xml_list) -> Xml.Element ("div", ("class", "blk_itm")::(("style","display:block")::attr_list), List.map (html_of_exml doc_class) xml_list)
...
|Xml.Element ("blk_blt", _, xml_list) -> Xml.Element ("div", [("class", "blk_blt");("style","display:block")], List.map (html_of_exml doc_class) xml_list)
...
|Xml.Element ("blk_dsp", _, xml_list) -> Xml.Element ("div", [("class", "blk_dsp");("style","display:block;white-space:nowrap")], List.map (html_of_exml doc_class) xml_list)
