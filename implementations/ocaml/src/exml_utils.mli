...
val xml_of_ts_blk_txt : Common_utils.t_doc_settings -> Common_utils.t_cref_table -> Common_utils.t_ftn_table -> Common_utils.t_path -> Doc_types.ts_blk_txt -> Xml.xml
...
val xml_of_ftn_table_opt : Common_utils.t_doc_settings -> Common_utils.t_cref_table -> Common_utils.t_path -> Common_utils.t_ftn_table -> Xml.xml option
