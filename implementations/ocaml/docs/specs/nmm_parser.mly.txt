...
nte_inline0:
  |nte_inline_short                               { $1 : ts_nte_inline}
  |nte_inline_long0                               { $1 : ts_nte_inline}
;

nte_inline_long0:
  |NTE_LBR lb1 blks1 RBR                          { Cs_nte_inline (Cs_blks $3, Cs_int $1) : ts_nte_inline}
;
...
blk_nte0:
  |star_tab_id lb1 blks1                          { { fld_blk_nte_id=$1; fld_blk_nte_main=Cs_blks $3} : tr_blk_nte }
;
...
blk(n):
  ...
  |blk_itm(n)                                       { Cu_blk_itm (blk_itm_tagger_ref.contents $1) : tu_blk }
  |blk_dsp(n)                                       { Cu_blk_dsp $1 : tu_blk }
  |blk_vrb(n)                                       { Cu_blk_vrb $1 : tu_blk }
  |blk_qtn(n)                                       { Cu_blk_qtn $1 : tu_blk }
;
...
nte_inline(n):
  |nte_inline_short                                       { $1 : ts_nte_inline}
  |nte_inline_long(n)                                     { $1 : ts_nte_inline}
;
...
qtn_lines(n):
  |qtn_line(n) nls                                { $1::[] : tu_qtn_line list }
  |qtn_line(n) nls qtn_lines(n)                   { $1::$3 : tu_qtn_line list }
;

qtn_line(n):
  |qtn_line_std(n)                                { Cu_qtn_line_std $1 : tu_qtn_line }
  |qtn_line_br(n)                                 { Cu_qtn_line_br $1 : tu_qtn_line }
;
...
qtn_units(n):
  |qtn_unit(n)                                    { ($1::[]):tu_qtn_unit list }
  |qtn_unit(n) qtn_units(n)                       { ($1::$2):tu_qtn_unit list }
;

qtn_unit(n):
  |qtn_unit_wysiwyg                               { Cu_qtn_unit_wysiwyg $1 : tu_qtn_unit }
  |qtn_unit_emph(n)                               { Cu_qtn_unit_emph $1 : tu_qtn_unit }
;

qtn_unit_emph(n):
  |STAR qtn_emph_txt(n) STAR                      { Cs_qtn_unit_emph $2:ts_qtn_unit_emph }
;
...
nte_inline1:
  |nte_inline_short                               { $1 : ts_nte_inline}
  |nte_inline_long1                               { $1 : ts_nte_inline}
;

nte_inline_long1:
  |NTE_LBR lb2 blks2 RBR                          { Cs_nte_inline (Cs_blks $3, Cs_int $1) : ts_nte_inline}
;
...
nte_inline2:
  |nte_inline_short                               { $1 : ts_nte_inline}
  |nte_inline_long2                               { $1 : ts_nte_inline}
;
...
txt_unit_nte:
  |txt_unit_wysiwyg_nte                           { Cu_txt_unit_wysiwyg $1 : tu_txt_unit }
  |txt_unit_emph_nte                              { Cu_txt_unit_emph $1 : tu_txt_unit }
  |txt_unit_c_ref                                 { Cu_txt_unit_c_ref $1 : tu_txt_unit }
;

txt_unit_wysiwyg_nte:
  |txt_nte                                        { Cs_txt_unit_wysiwyg $1 : ts_txt_unit_wysiwyg }
;

txt_unit_emph_nte:
  |STAR emph_txt_nte STAR                         { Cs_txt_unit_emph $2 : ts_txt_unit_emph }
;
...
emph_txt_nte:
  |txt_nte                                        { $1:string }
  |txt_nte emph_txt_nte                           { ($1 ^ $2):string }
;
...
nte_ref:
  |NTE_REF                                        { (nte_ref_of_string_int $1):ts_nte_ref }
;
...
ch_nl:
  |CH_TAG_OR_ID_NL                                { tag_or_id_of_string $1 : tu_tag_or_id }
;
